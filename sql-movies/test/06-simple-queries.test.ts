...
describe("Simple Queries", () => {
    ...
    it(
        ...
        async done => {
            ...
            expect(result).toEqual({
                total_budget: 51221081871.0,
                total_revenue: 139589164680.0
            });
    ...
    it(
        ...
        async done => {
            ...
            expect(result).toEqual([
                {count: 16479, month: "12"},
                {count: 16521, month: "11"},
                {count: 15175, month: "10"},
                {count: 10502, month: "09"},
                {count: 12812, month: "08"},
                {count: 14557, month: "07"},
                {count: 13655, month: "06"},
                {count: 13071, month: "05"},
                {count: 12623, month: "04"},
                {count: 14080, month: "03"},
                {count: 11765, month: "02"},
                {count: 14619, month: "01"}
            ]);
